              ...
              <v-row style="vertical-align:bottom;">
                <v-col cols="12" style="text-align:center;">
                  ...
                  <v-rating
                    :value="info.stars"
                    color="#ff85f3"
                    background-color="#ff85f3 lighten-3"
                    dense
                    half-increments
                    readonly
                    size="2.0vw"
            ...
            <v-col cols="12" class="cardRight">
                  ...
                  <v-col cols="6">
                    <v-col col="12">
                      <div align="center">
                        ...
                        <span style="color:#2adba3;font-size:4vh;vertical-align:top;">등급: {{ info.grade }}</span>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="5vh"
                          height="10vh"
              ...
              <v-row>
                ...
                <v-col cols="4">
                  <kinder-chart
                    title="교사 자격"
                    :number="[info.nOne,info.nTwo,info.nThree]"
                    :name="['1급','2급','3급']"
                    :color="color2"
                    :unit="'명'"
                    style="height:100%"
...
export default {
  ...
  data () {
    return {
      ...
      bar: [
        {
          title: '교사평균 근속연수', unit: '년', data: ['1.2', '2.0']
        },
        {
          title: '교사 1인당 유아 수', unit: '명', data: ['10', '18.2']
        },
        {
          title: '100m²당 CCTV수', unit: '개', data: ['3.2', '3.0']
        },
        {
          title: '교사 수', unit: '명', data: ['14', '13.5']
        },
        {
          title: '유아 수', unit: '명', data: ['45', '51']
        },
        {
          title: '실내 면적', unit: 'm²', data: ['146', '101']
        }
      ],
